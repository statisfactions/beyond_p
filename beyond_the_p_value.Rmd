...
null_flips = my_data %>% 
  specify(response = flip, success = "T") %>% 
  hypothesize("point", p = 0.5) %>% 
  generate(reps = 1000, type = "simulate")

```

This simulates flipping a fair coin 5 times, and repeating the process 1000 times.  Here's the first three groups of 5: first thre 
...
[https://tellmi.psy.lmu.de/felix/BayesLessons/BayesianLesson1.Rmd](Example app for Bayes)

## Resources

We're hear to help with any of this!
